import {
  ...
  __publicField,
  __reExport
} from "./chunk-2H6MCYB2.js";

// node_modules/@nuxtjs/i18n/node_modules/@intlify/vue-router-bridge/lib/index.mjs
var lib_exports = {};
__export(lib_exports, {
  default: () => lib_default,
  isVueRouter3: () => isVueRouter3,
  isVueRouter4: () => isVueRouter4,
  useRoute: () => useRoute,
  useRouter: () => useRouter
});
__reExport(lib_exports, vue_router_star);
import { useRouter, useRoute } from "vue-router";
import * as vue_router_star from "vue-router";
...
__reExport(lib_exports2, vue_i18n_star);
...
function createVueRouter(options, version) {
  if (isVue3 && version === 4) {
    return (0, lib_exports.createRouter)(options);
